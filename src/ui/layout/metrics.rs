...
const DEFAULT_PANEL_WIDTH: f32 = 825.0;
const DEFAULT_PANEL_RADIUS: f32 = 10.0;
const DEFAULT_ITEM_RADIUS: f32 = 8.0;
const DEFAULT_RESULTS_HEIGHT: f32 = 300.0;
...
const DEFAULT_SEARCH_ICON_SIZE: f32 = 18.0;
...
const DEFAULT_RESULT_PRIMARY_TEXT_SIZE: f32 = 14.0;
const DEFAULT_RESULT_SECONDARY_TEXT_SIZE: f32 = 12.0;
const DEFAULT_EMPTY_STATE_TEXT_SIZE: f32 = 14.0;
const DEFAULT_RESULT_LABEL_MAX_LEN: usize = 56;
const DEFAULT_RESULTS_TOP_BOTTOM_PADDING: f32 = 6.0;
const DEFAULT_RESULTS_SIDE_PADDING: f32 = 10.0;
const DEFAULT_BOTTOM_STRIP_HEIGHT: f32 = 31.0;

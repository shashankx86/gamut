...
fn light_scheme(seed: ThemeSeed) -> ResolvedAppearance {
    ...
    ResolvedAppearance {
        ...
        scrollbar_scroller: mix(primary_text, panel_background, 0.60),
        scrollbar_scroller_border: mix(primary_text, panel_background, 0.48),
        scrollbar_scroller_hover: mix(primary_text, panel_background, 0.50),
        scrollbar_scroller_hover_border: mix(primary_text, panel_background, 0.40),
        scrollbar_scroller_dragged: mix(primary_text, panel_background, 0.42),
        scrollbar_scroller_dragged_border: mix(primary_text, panel_background, 0.32),
    }
}
...
fn dark_scheme(seed: ThemeSeed) -> ResolvedAppearance {
    ...
    ResolvedAppearance {
        ...
        scrollbar_track: mix(primary_text, panel_background, 0.90),
        scrollbar_track_border: mix(primary_text, panel_background, 0.84),
        scrollbar_scroller: mix(primary_text, panel_background, 0.56),
        scrollbar_scroller_border: mix(primary_text, panel_background, 0.42),
        scrollbar_scroller_hover: mix(primary_text, panel_background, 0.46),
        scrollbar_scroller_hover_border: mix(primary_text, panel_background, 0.34),
        scrollbar_scroller_dragged: mix(primary_text, panel_background, 0.38),
        scrollbar_scroller_dragged_border: mix(primary_text, panel_background, 0.26),
    }
}
